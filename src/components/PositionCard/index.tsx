      ...
      <AutoColumn gap="12px">
        <FixedHeightRow>
          <AutoRow gap="8px">
            ...
            {!!stakedBalance && (
              <ButtonUNIGradient as={Link} to={`/ark/${currencyId(currency0)}/${currencyId(currency1)}`}>
                <HideExtraSmall>Earning ARK</HideExtraSmall>
                <ExtraSmallOnly>
          ...
          <AutoColumn gap="8px">
            ...
            {stakedBalance && JSBI.greaterThan(stakedBalance.raw, BIG_INT_ZERO) && (
              <ButtonPrimary
                ...
                borderRadius="8px"
                as={Link}
                to={`/ark/${currencyId(currency0)}/${currencyId(currency1)}`}
                width="100%"
              >
